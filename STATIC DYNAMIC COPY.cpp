...
system containing the following information: Name,rollno,class,div,date of birth,blood grp,
contact address,telephone number,driving licenc no.etc.Consturct the database with suitable
member functions for initialinzing  and destroying data viz constructor ,default constructor,copy constructor
destructor ,static member functions,friend class,this pointer ,inline code,
and dynamic memory alloction operstors-new and delete*/
